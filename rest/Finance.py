...
class FinanceAPI:
    ...
    def get_defi_active_orders(self, productId='', protocolType='', ccy='', state=''):
        ...
        return self._client._request_with_params(GET, STACK_DEFI_ORDERS_ACTIVITY, params)

    def get_defi_orders_history(self, productId='', protocolType='', ccy='', after='', before='', limit=''):
        params = {
            'productId': productId,
            'protocolType': protocolType,
            'ccy': ccy,
    ...
    def get_eth_purchase_redeem_history(self, type='', status='', after='', before='', limit=''):
        params = {}
        if type:
            params['type'] = type
        if status:
        ...
        if limit:
            params['limit'] = limit
        return self._client._request_with_params(GET, STACK_ETH_PURCHASE_REDEEM_HISTORY, params)
    ...
    def get_sol_purchase_redeem_history(self, type='', status='', after='', before='', limit=''):
        params = {}
        if type:
            params['type'] = type
        if status:
        ...
        if limit:
            params['limit'] = limit
        return self._client._request_with_params(GET, STACK_SOL_PURCHASE_REDEEM_HISTORY, params)
    ...
    def savings_purchase_redemption(self, ccy='', amt='', side='', rate=''):
        ...
        return self._client._request_with_params(POST, SAVING_PURCHASE_REDEMPTION, params)
    ...
    def adjust_collateral(self, type='', collateralCcy='', collateralAmt=''):
        ...
        return self._client._request_with_params(POST, FINANCE_ADJUST_COLLATERAL, params)

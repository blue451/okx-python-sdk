...
MANUAL_BORROW_REPAY = '/api/v5/account/spot-manual-borrow-repay'  # 别名，保持向后兼容
...
INDEX_CANSLES = '/api/v5/market/index-candles'  # 保持向后兼容，但这是拼写错误
...
PLATFORM_24_VOLUME = '/api/v5/market/platform-24-volume'  # 别名，保持向后兼容
...
GET_OPTION_INSTRUMENT_FAMILY_TRADES = '/api/v5/market/option/instrument-family-trades'  # 别名，保持向后兼容
...
DICCOUNT_INTETEST_INFO = '/api/v5/public/discount-rate-interest-free-quota'  # 保持向后兼容，但这是拼写错误

...
class AsyncFinanceAPI:
    ...
    async def defi_purchase(self, productId='', investData=[], term='', tag=''):
        ...
        if tag:
            params['tag'] = tag
        return await self._client._request_with_params(POST, STACK_DEFI_PURCHASE, params)
    ...
    async def get_defi_active_orders(self, productId='', protocolType='', ccy='', state=''):
        params = {
            'productId': productId,
            'protocolType': protocolType,
            'ccy': ccy,
        ...
        return await self._client._request_with_params(GET, STACK_DEFI_ORDERS_ACTIVITY, params)

    async def get_defi_orders_history(self, productId='', protocolType='', ccy='', after='', before='', limit=''):
        params = {
            'productId': productId,
            'protocolType': protocolType,
            'ccy': ccy,
        ...
        return await self._client._request_with_params(GET, STACK_DEFI_ORDERS_HISTORY, params)
    ...
    async def get_eth_purchase_redeem_history(self, type='', status='', after='', before='', limit=''):
        params = {}
        if type:
            params['type'] = type
        if status:
        ...
        if limit:
            params['limit'] = limit
        return await self._client._request_with_params(GET, STACK_ETH_PURCHASE_REDEEM_HISTORY, params)

    async def get_eth_apy_history(self, days):
        params = {'days': days}
        return await self._client._request_with_params(GET, STACK_ETH_APY_HISTORY, params)
    ...
    async def get_sol_purchase_redeem_history(self, type='', status='', after='', before='', limit=''):
        params = {}
        if type:
            params['type'] = type
        if status:
        ...
        if limit:
            params['limit'] = limit
        return await self._client._request_with_params(GET, STACK_SOL_PURCHASE_REDEEM_HISTORY, params)

    async def get_sol_apy_history(self, days):
        params = {'days': days}
        return await self._client._request_with_params(GET, STACK_SOL_APY_HISTORY, params)
    ...
    async def savings_purchase_redemption(self, ccy='', amt='', side='', rate=''):
        ...
        return await self._client._request_with_params(POST, SAVING_PURCHASE_REDEMPTION, params)
    ...
    async def get_public_borrow_info(self, ccy=''):
        params = {'ccy': ccy}
        return await self._client._request_with_params(GET, GET_PUBLIC_BORROW_INFO, params)
    ...
    async def get_public_borrow_history(self, ccy='', after='', before='', limit=''):
        ...
        return await self._client._request_with_params(GET, GET_PUBLIC_BORROW_HISTORY, params)
    ...
    async def get_loan_currencies(self):
        return await self._client._request_without_params(GET, FINANCE_BORROW_CURRENCIES)

    async def get_collateral_assets(self, ccy=''):
        params = {}
        if ccy:
            params['ccy'] = ccy
        return await self._client._request_with_params(GET, FINANCE_COLLATERAL_ASSETS, params)
    ...
    async def adjust_collateral(self, type='', collateralCcy='', collateralAmt=''):
        ...
        return await self._client._request_with_params(POST, FINANCE_ADJUST_COLLATERAL, params)
    ...
    async def get_loan_history(self, type='', after='', before='', limit=''):
        ...
        if limit:
            params['limit'] = limit
        return await self._client._request_with_params(GET, FINANCE_LOAN_HISTORY, params)
    ...
    async def get_interest_accrued(self, ccy='', after='', before='', limit=''):
        ...
        if limit:
            params['limit'] = limit
        return await self._client._request_with_params(GET, FINANCE_INTEREST_ACCRUED, params)
